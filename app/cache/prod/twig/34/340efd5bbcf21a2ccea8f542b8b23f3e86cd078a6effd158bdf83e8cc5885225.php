...
class __TwigTemplate_ad652386041b32ce1fb11681c478d365f268b575ebccf68cbd5b6385ff0eb015 extends Twig_Template
{
    ...
    ";
        ...
        if ($this->getAttribute(($context["collector"] ?? null), "tokenClass", array())) {
            ...
            if ($this->getAttribute(($context["collector"] ?? null), "supportsRoleHierarchy", array())) {
                ...
                <td>";
                // line 73
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\YamlExtension')->encode($this->getAttribute(($context["collector"] ?? null), "inheritedRoles", array())), "html", null, true);
                echo "</td>
            </tr>
            ";
            }
...
($context["collector"] ?? null), "enabled", array())) {
    ...
    {
        return new Twig_Source("", "SecurityBundle:Collector:security.html.twig", "/var/www/html/sga/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views/Collector/security.html.twig");
    }
}
