...
namespace Proxies\__CG__\Admin\Backend\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Admin\Backend\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Admin\\Backend\\Entity\\User' . "\0" . 'ultimoLogin', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setUltimoLogin($ultimoLogin)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUltimoLogin', array($ultimoLogin));
    ...
    public function getUltimoLogin()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUltimoLogin', array());
