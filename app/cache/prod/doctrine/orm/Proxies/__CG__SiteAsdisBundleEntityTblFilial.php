 ...
 */
class TblFilial extends \Site\AsdisBundle\Entity\TblFilial implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Site\\AsdisBundle\\Entity\\TblFilial' . "\0" . 'idFilial', '' . "\0" . 'Site\\AsdisBundle\\Entity\\TblFilial' . "\0" . 'adress', '' . "\0" . 'Site\\AsdisBundle\\Entity\\TblFilial' . "\0" . 'descrition', '' . "\0" . 'Site\\AsdisBundle\\Entity\\TblFilial' . "\0" . 'telefone', '' . "\0" . 'Site\\AsdisBundle\\Entity\\TblFilial' . "\0" . 'email', '' . "\0" . 'Site\\AsdisBundle\\Entity\\TblFilial' . "\0" . 'fax', '' . "\0" . 'Site\\AsdisBundle\\Entity\\TblFilial' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TblFilial $proxy) {
    ...
    public function getIdFilial()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdFilial();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdFilial', array());

        return parent::getIdFilial();
    }
    ...
    public function setDescrition($descrition)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDescrition', array($descrition));
    ...
    public function getDescrition()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDescrition', array());
